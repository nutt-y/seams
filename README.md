...
Install [deno](https://docs.deno.com/runtime/getting_started/installation/) version **2.7.***. Run `deno run build` to compile the binary locally for your machine's specifications. This project uses **Deno's** in-built type checker.
